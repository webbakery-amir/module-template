...
namespace WebBakery\Credit\Migrations;
...
final class Version20220321134600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!$schema->hasTable('oemt_tracker')) {
            $this->addSql("CREATE TABLE `oemt_tracker` (
            ...
            `OEMTCOUNT` int(11) NOT NULL DEFAULT '0' COMMENT 'Greeting update count',
