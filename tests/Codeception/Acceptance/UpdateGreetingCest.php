 ...
 * @group Playground_module-template_updategreeting
 */
final class UpdateGreetingCest
{
    ...
    public function testSetGreetingMode(AcceptanceTester $I): void
    {
        ...
        $I->seeElement('#oemtgreeting_submit');
        $I->seeElement('#oemt_greeting_input');
        $I->fillField(ModuleCore::OEMT_GREETING_TEMPLATE_VARNAME, 'Hello master of the filled cart');
        $I->click('#oemtgreeting_submit');
    ...
    public function testAnonymousUserAccessingModuleController(AcceptanceTester $I): void
    {
        ...
        $I->see(Translator::translate('OEMODULETEMPLATE_GREETING_UPDATE_COUNT') . '0');
        $I->assertEmpty($I->grabValueFrom(ModuleCore::OEMT_GREETING_TEMPLATE_VARNAME));
